...
<% model obj = new model();
obj.allstaff();
session.setAttribute("staffobj", obj.staffobj);
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-12">
    				...
    				<c:forEach items="${staffobj}" var="staff">
    				<form action="viewdetailedstaff" id="${staff.staffid}" method="post">
    				<a href="javascript:{}" onclick="document.getElementById('${staff.staffid}').submit();">
    				<div class="view-cars">
