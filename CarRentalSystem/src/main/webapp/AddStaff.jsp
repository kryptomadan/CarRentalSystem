      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs mb-2"><span class="mr-2"><a href="AdminHomePage.jsp">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Add New Staff<i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-0 bread">Add Staff</h1>
          </div>
        </div>
      </div>
    </section>
								...
								<div class="col-md-7">
									<div class="contact-wrap w-100 p-md-5 p-4">
										...
										<!-- to upload aadhar file -->
											<form action="staffaadharupload"  method="post" enctype="multipart/form-data">
											
											<%
											if (session.getAttribute("staffaadharnumber") == null)
											{
											%>
											...
											<div class="col-md-12">
												...
												<div class="col-md-12">
													<div class="form-group">
														<label class="label" for="subject">Aadhar Number</label>
														<label class="label"> <mark> ${staffaadharnumber}</mark></label>	
													</div>
												</div><% } %>
										...
										<form method="POST" id="contactForm" name="contactForm" class="contactForm" action="addstaff">
											<div class="row">
